...
/**
 * <p>MyBatis-Plus 代码自动生成</p>
 * <p>用于自动生成表实体类、Controller等</p>
 *
 * @author scyking
 * @since 2018-9-18
 */
public class MPGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 文件生成目录
        gc.setOutputDir("F:\\workspace\\auto\\spring-boot-demo\\src\\main\\java");
...
//         gc.setControllerName("%sController");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/spring-boot-demo?characterEncoding=utf8");
